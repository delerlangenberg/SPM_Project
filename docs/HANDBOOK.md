...
- [Adaptive object release v1.3.1.0](RELEASE_v1.3.1.0.md)
- [Stage 2 surface calibration report](STAGE2_SURFACE_CALIBRATION_REPORT_20260730.md)
- [Random two-magnet adaptive test](STAGE2_RANDOM_TWO_MAGNET_TEST_20260731.md)
...
### Surface-calibration mission — 30 July 2026

The full-field mission completed 87 physical contacts: 42 overview, 30
speed/resolution comparison and 15 adaptive focused points. The calibrated
default is **Balanced** (10 mm XY pitch, 0.60 mm/s approach, 0.050 mm Z
increment). **Fast Survey** is the maximum validated approach profile;
**Precision** is the best practical detailed profile. **Research Limit**
exposed a 20 µm five-contact spread and is not a claim of 10 µm accuracy.

See the [complete calibration report](STAGE2_SURFACE_CALIBRATION_REPORT_20260730.md)
and `config/stage2_calibrated_scan_profiles.json`. The final safe state was
X20.50, Y97.50, Z45.00 with **Probe In**.

### Random-object discovery validation — 31 July 2026

Two 29.3 mm × 11.3 mm magnets were placed without providing their coordinates.
A 143-point, 20 mm overview found two separated regions; the system then ran
two automatic 64-point, 5 mm focused maps. The final centers were X80.50/Y87.50
and X185.50/Y132.50 in native coordinates. The complete run produced 271
physical readings and 62 contacts.

This success is implemented in the operator software as **Discover & Refine
Objects**. Balanced (20 mm → 5 mm) is the validated default. Object-count
discovery is now generic from one to 12 separated regions; it is no longer
mathematically forced to find exactly two. See the
[complete test record](STAGE2_RANDOM_TWO_MAGNET_TEST_20260731.md).
