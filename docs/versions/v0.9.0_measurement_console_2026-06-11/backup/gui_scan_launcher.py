...
class ScanGUI(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Educational SPM - Prusa MK4S Workstation")
        ...
        measurement_left.addWidget(xy_scan_group)
        measurement_left.addWidget(z_group)
        measurement_left.addStretch()
        measurement_layout.addLayout(measurement_left, 1)
        measurement_right = QVBoxLayout()
        measurement_right.addWidget(measurement_actions_group)
        measurement_right.addWidget(measurement_live_group)
        measurement_right.addStretch()
        measurement_layout.addLayout(measurement_right, 2)

        self.scan_setup_dialog = self.build_tool_dialog("Measurement", measurement_layout, 1040, 760)
        ...
        self.z_tools_dialog = self.scan_setup_dialog
        ...
        tools_row.addWidget(self.open_z_tools_btn)
    ...
    def build_tool_dialog(self, title: str, content_layout: QVBoxLayout, width: int, height: int) -> QDialog:
        dialog = QDialog(self)
        dialog.setWindowTitle(f"Educational SPM - {title}")
