(function () {
  ...
  function openTab() {
    ...
    if (!w) return;
    w.document.title = "SPM Live Log";
    w.document.body.innerHTML = "<pre style='white-space:pre-wrap;background:#060a12;color:#e5e7eb;padding:16px;font:12px Consolas,monospace'></pre>";
    w.document.querySelector("pre").textContent = memory.join("\n") + "\n";
  }
